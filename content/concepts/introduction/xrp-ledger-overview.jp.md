...
XRP元帳は、ピアツーピアサーバーのネットワークによって強化された分散型の暗号化元帳です。 XRP元帳は、世界中で使用されているさまざまな通貨をつなぐように設計されたデジタル資産であるXRPの本拠地です。リップルはXRP元帳の開発を管理し、価値のインターネットへの重要な貢献としてXRPを前進させます。お金が今日情報を動かす方法で動く世界。
